package nirmesh.ndtv.fragments;
...
import nirmesh.ndtv.Contants;
import nirmesh.ndtv.detailslist.PatientDetail;
...
public class PatientDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toBetakon = (TextView) rootView.findViewById(R.id.toBetaken);
        ...
        try {
            ...
            for (int i = 0; i < jArry.length(); i++) {
                ...
                patientDetail.setToBetaken(jo_inside.getString("toBeTaken"));
        ...
        if (patientDetails != null) {
            ...
            toBetakon.setText("ToBetakon :" + patientDetails.toBetaken);
